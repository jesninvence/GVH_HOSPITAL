    ...
    return ( 
        <>
            ...
            <div className="carrers d-flex position-relative m-2">
                ...
                <div className="flex-shrink-0">
                    <Link to="/humanres" className="mas">
                        <a href="" className="mas" style={{backgroundColor: "#0073ff", color: "white"}}>Human Resources</a>
                    </Link>
                </div>
                <div className="flex-shrink-0">
                    <Link to="/infortech">
                ...
                <div className="row">
                    <div className="col-4">
                        ...
                        <div className="carrer-link">
                            <Link to="/hrspecialist">
                                <a href="">HR Specialist</a>
                            </Link>
                            <hr />
                        </div>
                    </div>
